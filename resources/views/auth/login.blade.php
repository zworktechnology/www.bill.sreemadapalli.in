...
@section('content')
    <div class="account-content">
        <div class="login-wrapper" style="background-image: url({{ asset('assets/backend/img/login.jpeg') }}); background-repeat: no-repeat; background-size: cover;">
            <div class="login-content" style="background-color: white;opacity: 97%;">
                <div class="login-userset" style="width: 60% !important">
                    ...
                    <div class="form-login">
                        ...
                        <div class="form-addons">
                            ...
                            autofocus placeholder="Enter your username or email address">
