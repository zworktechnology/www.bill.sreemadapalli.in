<div class="modal-dialog modal-l">
    <div class="modal-content">
        ...
        <div class="modal-body">
            <form autocomplete="off" method="POST" action="{{ route('payoff.update', ['unique_key' => $datas['unique_key']]) }}" enctype="multipart/form-data">
                  @method('PUT')
                    @csrf
                <div class="row">
                        ...
                        <div class="col-lg-12 col-sm-6 col-12">
                            <div class="form-group">
                                <label style="font-size:15px;padding-top: 5px;padding-bottom: 2px;">Employee<span
                                        style="color: red;">*</span></label>
                                <input type="text" name="employee" class="employee"  value="{{ $datas['employee']  }}" readonly>
                            </div>
                        </div>
                        <div class="col-lg-12 col-sm-6 col-12">
                            <div class="form-group">
                                <label style="font-size:15px;padding-top: 5px;padding-bottom: 2px;">Day Salary<span
                                        style="color: red;">*</span></label>
                                <input type="text" name="perday_salary" class="payoffedit_perday_salary" readonly value="{{ $datas['perdaysalary']  }}">
                            </div>
                        </div>
                        <div class="col-lg-12 col-sm-6 col-12">
                            <div class="form-group">
                                <label style="font-size:15px;padding-top: 5px;padding-bottom: 2px;">Amount Given<span
                                        style="color: red;">*</span></label>
                                <input type="text" name="amountgiven" class="payoffedit_amountgiven"  value="{{ $datas['amountgiven']  }}">
                            </div>
                        </div>
                        <div class="col-lg-12 col-sm-6 col-12">
                            <div class="form-group">
