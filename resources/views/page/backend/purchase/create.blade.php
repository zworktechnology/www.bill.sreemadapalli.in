                  ...
                  <div class="row">
                        ...
                        <div class="col-lg-3 col-sm-3 col-12">
                            <div class="form-group">
                                ...
                                <input type="text" name="bill_no" placeholder="Enter Bill No" value="{{$billno}}" readonly>
                            </div>
                        </div>
                        <div class="col-lg-3 col-sm-3 col-12">
                            <div class="form-group">
                        ...
                        <div class="col-lg-6 col-sm-6 col-12">
                            <div class="form-group">
                                <label style="font-size:15px;padding-top: 5px;padding-bottom: 2px;">Total Amount<span
                                        style="color: red;">*</span></label>
                                <input type="text" name="purchasetotal_amount" class="purchasetotal_amount" placeholder="Enter Total Amount">
                            </div>
                        </div>
                        <div class="col-lg-6 col-sm-6 col-12">
                            <div class="form-group">
                                <label style="font-size:15px;padding-top: 5px;padding-bottom: 2px;">Payable Amount<span
                                        style="color: red;">*</span></label>
                                <input type="text" name="purchasepaidamount" class="purchasepaidamount" placeholder="Enter Payable Amount" required>
                            </div>
                        </div>
                        <div class="col-lg-6 col-sm-6 col-12">
                            <div class="form-group">
