...
@section('content')
    <div class="content">
        ...
        <div class="card">
            <div class="card-body">
                <form autocomplete="off" method="POST" action="{{ route('emp_attendance.store') }}"
                                                ...
                                                <div style="display: flex">
                                                    <div class="input-group" style="margin-right: 5px;">
                                                        <div class="input-group-text">
                                                            <input class="form-check-input" type="radio" value="Present"
                                                                id="attendance{{ $employees->id }}"
                                                                name="attendance[{{ $employees->id }}]"
                                                    ...
                                                    <div class="input-group" style="margin-right: 5px;">
                                                        <div class="input-group-text">
                                                            <input class="form-check-input" type="radio" value="Leave"
                                                                id="attendance{{ $employees->id }}"
                                                                name="attendance[{{ $employees->id }}]"
                                                                aria-label="Radio button for following text input">
                                                        </div>
                                                    ...
                                                    <div class="input-group">
                                                        <div class="input-group-text">
                                                            <input class="form-check-input" type="radio"
                                                                value="Sick Leave" id="attendance{{ $employees->id }}"
                                                                name="attendance[{{ $employees->id }}]"
                                                                aria-label="Radio button for following text input">
                                                        </div>
