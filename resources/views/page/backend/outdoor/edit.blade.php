                            ...
                            <table class="table">
                                ...
                                @foreach ($Outdoordata as $index => $Outdoordatas)
                                    <tr>
                                       ...
                                       <input type="text" class="form-control outdoor_product" id="outdoor_product" name="outdoor_product[]" 
                                       placeholder="Product Name" value="{{ $Outdoordatas->outdoor_product }}" required />
                                       </td>
