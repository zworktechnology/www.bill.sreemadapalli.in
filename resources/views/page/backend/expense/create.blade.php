                        ...
                        <div class="table-responsive col-lg-12 col-sm-12 col-12">
                            <table class="table">
                                ...
                                <tbody class="expense_fields">
                                    <tr>
                                        <td>
                                          <input type="hidden"id="expenes_detail_id"name="expenes_detail_id[]" value=""/>
                                            <input type="text" class="form-control note" id="note" name="note[]"placeholder="note" value="" required />
                                        </td>
                                        <td>
                                            <input type="text" class="form-control expenseprice" id="expenseprice" name="expenseprice[]" placeholder="Price" value="" required />
                                        </td>
                                ...
                                <tr>
                                 <td></td>
                                 <td><input type="text" class="form-control expensetotal_price" id="total_price" name="total_price" placeholder="Total" readonly /></td></tr>
                                </tbody>
                            </table>
                        </div>
                  </div>
