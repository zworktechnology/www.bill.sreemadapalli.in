        ...
        <div class="card">
            <div class="card-body">
                <form autocomplete="off" method="POST"
                    action="{{ route('expense.update', ['unique_key' => $Expense->unique_key]) }}"
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control js-example-basic-single select" name="bank_id" id="bank_id">
                                    ...
                                    @foreach ($Bank as $Banks)
                                        <option
                                            value="{{ $Banks->id }}"@if ($Banks->id === $Expense->bank_id) selected='selected' @endif>
                                            {{ $Banks->name }}</option>
                                    @endforeach
                                </select>
                            </div>
                                        ...
                                        <tr>
                                            <td>
                                                <input type="hidden"id="expenes_detail_id" name="expenes_detail_id[]"
                                                    value="{{ $Expensedatas->id }}" />
                                                <input type="text" class="form-control note" id="note"
                                                    name="note[]" placeholder="note" value="{{ $Expensedatas->note }}"
                                                    required />
                                            </td>
                                            <td>
                                                <input type="text" class="form-control expenseprice" id="expenseprice"
                                                    value="{{ $Expensedatas->price }}" name="expenseprice[]"
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td><input type="text" class="form-control expensetotal_price" id="total_price"
                                                value="{{ $Expense->total_price }}" name="total_price" placeholder="Total"
                                                readonly /></td>
                                    </tr>
                                </tbody>
                            </table>
