        ...
        <div class="card-body">
            <div class="form-group-item">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-4">
                        <div class="form-group" style="margin-bottom: 10px;">
                            <input type="text" class="rupee" name="rupee[]" id="rupee3" Value="200" readonly
                                style="background: bisque;">
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-3 col-sm-3">
                    ...
                    <div class="col-lg-5 col-md-5 col-sm-5">
                        <div class="form-group" style="margin-bottom: 10px;">
                            <input type="text" class="determinationamount" name="amount[]" id="amount3" readonly
                                style="background: #97a2d236;">
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-4 col-sm-4">
                        <div class="form-group" style="margin-bottom: 10px;">
                            <input type="text" class="rupee" name="rupee[]" id="rupee4" Value="100" readonly
                                style="background: bisque;">
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-3 col-sm-3">
                    ...
                    <div class="col-lg-5 col-md-5 col-sm-5">
                        <div class="form-group" style="margin-bottom: 10px;">
                            <input type="text" class="determinationamount" name="amount[]" id="amount4"
                                readonly style="background: #97a2d236;">
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-4 col-sm-4">
                        <div class="form-group" style="margin-bottom: 10px;">
                            <input type="text" class="rupee" name="rupee[]" id="rupee5" Value="50"
                                readonly style="background: bisque;">
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-3 col-sm-3">
                        <div class="form-group" style="margin-bottom: 10px;">
                    ...
                    <div class="col-lg-5 col-md-5 col-sm-5">
                        <div class="form-group" style="margin-bottom: 10px;">
                            <input type="text" class="determinationamount" name="amount[]" id="amount5"
                                readonly style="background: #97a2d236;">
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-4 col-sm-4">
                        <div class="form-group" style="margin-bottom: 10px;">
                            <input type="text" class="rupee" name="rupee[]" id="rupee6" Value="20"
                                readonly style="background: bisque;">
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-3 col-sm-3">
                    ...
                    <div class="col-lg-5 col-md-5 col-sm-5">
                        <div class="form-group" style="margin-bottom: 10px;">
                            <input type="text" class="determinationamount" name="amount[]" id="amount6"
                                readonly style="background: #97a2d236;">
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-4 col-sm-4">
                        <div class="form-group" style="margin-bottom: 10px;">
                            <input type="text" class="rupee" name="rupee[]" id="rupee7" Value="10"
                                readonly style="background: bisque;">
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-3 col-sm-3">
                    ...
                    <div class="col-lg-5 col-md-5 col-sm-5">
                        <div class="form-group" style="margin-bottom: 10px;">
                            <input type="text" class="determinationamount" name="amount[]" id="amount7"
                                readonly style="background: #97a2d236;">
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-4 col-sm-4">
                        <div class="form-group" style="margin-bottom: 10px;">
                            <input type="text" class="rupee" name="rupee[]" id="rupee8" Value="5"
                                readonly style="background: bisque;">
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-3 col-sm-3">
                    ...
                    <div class="col-lg-5 col-md-5 col-sm-5">
                        <div class="form-group" style="margin-bottom: 10px;">
                            <input type="text" class="determinationamount" name="amount[]" id="amount8"
                                readonly style="background: #97a2d236;">
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-4 col-sm-4">
                        <div class="form-group" style="margin-bottom: 10px;">
                            <input type="text" class="rupee" name="rupee[]" id="rupee9" Value="2"
                                readonly style="background: bisque;">
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-3 col-sm-3">
                    ...
                    <div class="col-lg-5 col-md-5 col-sm-5">
                        <div class="form-group" style="margin-bottom: 10px;">
                            <input type="text" class="determinationamount" name="amount[]" id="amount9"
                                readonly style="background: #97a2d236;">
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-4 col-sm-4">
                        <div class="form-group" style="margin-bottom: 10px;">
                            <input type="text" class="rupee" name="rupee[]" id="rupee10" Value="1"
                                readonly style="background: bisque;">
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-3 col-sm-3">
                    ...
                    <div class="col-lg-5 col-md-5 col-sm-5">
                        <div class="form-group" style="margin-bottom: 10px;">
                            <input type="text" class="determinationamount" name="amount[]" id="amount10"
                                readonly style="background: #97a2d236;">
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-4 col-sm-4">
                    ...
                    <div class="col-lg-8 col-md-8 col-sm-5">
                        <div class="form-group" style="margin-bottom: 10px;">
                            <input type="text" class="determinationtotal_amount" name="total_amount"
                                id="total_amount1" readonly style="background: #e9e549c7;text-align:right">
                        </div>
                    </div>
                </div>
