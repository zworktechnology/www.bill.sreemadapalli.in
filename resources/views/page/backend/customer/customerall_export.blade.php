...
<body>
   <div class="logoname">
        <div>
            <h4  style="text-transform: uppercase; color:red;text-align:center;">Customer Report</h4>
    ...
    <table id="customers">
        ...
        <tbody id="customer_index">
            ...
            @if ($customerdatas['pending_amount'] != '')
                                                <td style="color: red;"> {{ $customerdatas['pending_amount'] }}</td>
                                            @elseif ($customerdatas['account_balance'] != '')
                                                <td  style="color: green;">
                                                 {{ $customerdatas['account_balance'] }}
                                                </td>
                                                @else
                                                <td></td>
                                            @endif
